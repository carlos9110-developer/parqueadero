...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <!-- Main Content -->
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-center" id="div-btn-registrar-editar-informacion">
                                                <button class="btn btn-success" type="submit" id="btn_guardar"><i class="fas fa-save"></i> <b> Registrar Información</b></button>
                                            </div>
                                        </div>
                                    </div>   
                                </div>
        ...
        <script src="<?php echo RUTA_URL?>/RegistroParqueaderos/files?js=Assets/js/insertar.js"></script>
