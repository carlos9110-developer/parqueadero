...
define('RUTA_URL', 'http://localhost/parqueadero'); // este se cambiaria en el servidor
...
//  RUTA DEL LOGO
define('RUTA_LOGO', 'http://localhost/parqueadero/public/img/logo_parking.jpg'); // este se cambiaria en el servidor:8080
