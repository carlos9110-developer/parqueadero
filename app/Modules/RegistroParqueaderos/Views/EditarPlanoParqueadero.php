...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <!-- Main Content -->
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <div class="row">
                        <input type="hidden" id="input-id" value="<?= $datos['datosParqueadero']->id;?>">
                        <!-- INFORMACIÓN PISOS -->
                        <div class="col-lg-2">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <ul id="list-config-pisos" class="list-group">
                                        	<?php foreach ($datos['pisosParqueadero'] as $piso): ?>
                                        		<li id="item-piso-<?= $piso->id ?>" onclick="eleccionPiso('<?= $piso->id ?>')" class="list-group-item cursor">Piso #<?= $piso->piso ?></li>
                                        	<?php endforeach; ?>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div  class="row">
                                <div class="col-lg-4">
                                    <div class="input-group mb-3">
                                        ...
                                        <input   min="1" type="number"  class="form-control" placeholder="# Filas" id="num_filas" disabled="">    
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="input-group mb-3">
                                        ...
                                        <input   min="1" type="number"  class="form-control" placeholder="# Columnas" id="num_columnas" disabled>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="<?php echo RUTA_URL?>/RegistroParqueaderos/files?js=Assets/js/editarPlanoParqueadero.js"></script>
